...
const Cart = () => {
    ...
    const { totalPrice, totalQuantity, cartItems, setShowCart, toggleCartItemQty, onRemove } = useStateContext();
    ...
    const handleCheckout = async () => {
        ...
        toast.loading('Please wait while we brew a cup...');
            ...
            <div className='cart-container'>
                ...
                {cartItems.length < 1 && (
                    <div className='empty-cart'>
                        ...
                        <h3>This cart ain't have nothin in it!</h3>
                        <Link href='/'>
                            <button
                                type='button'
